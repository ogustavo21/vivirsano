...
public class MainActivityH5 extends AppCompatActivity implements interfaz5, NavigationView.OnNavigationItemSelectedListener {
    private final String LOG_TAG = "MainActivity";
    private PagerAdapter5 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainhcinco);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_viewh5);
        ...
        adapter = new PagerAdapter5(getSupportFragmentManager(), tabs);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            if (fragment != null) {
                switch (position) {
                    case 0:
                        ((TabFragmentH51) fragment).onRefresh();
                        break;
                    case 1:
                        ((TabFragmentH52) fragment).onRefresh();
                        break;
                    case 3:
                        ((TabFragmentH53) fragment).onRefresh();
                        break;
                }
            }
            startActivity(new Intent(MainActivityH5.this, datosSesion.class));
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.habito1) {
            ...
            startActivity(new Intent(MainActivityH5.this, MainActivityH1.class));
        } else if (id == R.id.habito2) {
            startActivity(new Intent(MainActivityH5.this, MainActivityH2.class));

        } else if (id == R.id.habito3) {
            startActivity(new Intent(MainActivityH5.this, MainActivityH3.class));

        } else if (id == R.id.habito4) {
            startActivity(new Intent(MainActivityH5.this, MainActivityH4.class));

        } else if (id == R.id.habito5) {
            startActivity(new Intent(MainActivityH5.this, MainActivityH5.class));

        } else if (id == R.id.habito6) {
            startActivity(new Intent(MainActivityH5.this, MainActivityH6.class));

        } else if (id == R.id.habito7) {
            startActivity(new Intent(MainActivityH5.this, MainActivityH7.class));


        } else if (id == R.id.habito8) {
            startActivity(new Intent(MainActivityH5.this, MainActivityH8.class));
    ...
    public void logout() {
        ...
        editor.clear();
        editor.commit();
        startActivity(new Intent(MainActivityH5.this, MainActivity.class));
    }


    public void guardarh5() {
        ...
        requestParams.add("habito", String.valueOf(5));
