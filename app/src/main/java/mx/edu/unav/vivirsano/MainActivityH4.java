...
public class MainActivityH4 extends AppCompatActivity implements interfaz4, NavigationView.OnNavigationItemSelectedListener {
    private final String LOG_TAG = "MainActivity";
    private PagerAdapter4 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainhcuatro);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_viewh4);
        ...
        adapter = new PagerAdapter4(getSupportFragmentManager(), tabs);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            if (fragment != null) {
                switch (position) {
                    case 0:
                        ((TabFragmentH41) fragment).onRefresh();
                        break;
                    case 1:
                        ((TabFragmentH42) fragment).onRefresh();
                        break;
                    case 3:
                        ((TabFragmentH43) fragment).onRefresh();
                        break;
                }
            }
            startActivity(new Intent(MainActivityH4.this, datosSesion.class));
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.habito1) {
            ...
            startActivity(new Intent(MainActivityH4.this, MainActivityH1.class));
        } else if (id == R.id.habito2) {
            startActivity(new Intent(MainActivityH4.this, MainActivityH2.class));

        } else if (id == R.id.habito3) {
            startActivity(new Intent(MainActivityH4.this, MainActivityH3.class));

        } else if (id == R.id.habito4) {
            startActivity(new Intent(MainActivityH4.this, MainActivityH4.class));

        } else if (id == R.id.habito5) {
            startActivity(new Intent(MainActivityH4.this, MainActivityH5.class));

        } else if (id == R.id.habito6) {
            startActivity(new Intent(MainActivityH4.this, MainActivityH6.class));

        } else if (id == R.id.habito7) {
            startActivity(new Intent(MainActivityH4.this, MainActivityH7.class));


        } else if (id == R.id.habito8) {
            startActivity(new Intent(MainActivityH4.this, MainActivityH8.class));
    ...
    public void logout() {
        ...
        editor.clear();
        editor.commit();
        startActivity(new Intent(MainActivityH4.this, MainActivity.class));
    }


    public void guardarh4() {
        ...
        requestParams.add("habito", String.valueOf(4));
