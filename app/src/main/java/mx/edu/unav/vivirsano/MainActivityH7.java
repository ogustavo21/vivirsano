...
public class MainActivityH7 extends AppCompatActivity implements interfaz7, NavigationView.OnNavigationItemSelectedListener {
    private final String LOG_TAG = "MainActivity";
    private PagerAdapter7 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainhsiete);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_viewh7);
        ...
        adapter = new PagerAdapter7(getSupportFragmentManager(), tabs);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            if (fragment != null) {
                switch (position) {
                    case 0:
                        ((TabFragmentH71) fragment).onRefresh();
                        break;
                    case 1:
                        ((TabFragmentH72) fragment).onRefresh();
                        break;
                    case 3:
                        ((TabFragmentH73) fragment).onRefresh();
                        break;
                }
            }
            startActivity(new Intent(MainActivityH7.this, datosSesion.class));
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.habito1) {
            ...
            startActivity(new Intent(MainActivityH7.this, MainActivityH1.class));
        } else if (id == R.id.habito2) {
            startActivity(new Intent(MainActivityH7.this, MainActivityH2.class));

        } else if (id == R.id.habito3) {
            startActivity(new Intent(MainActivityH7.this, MainActivityH3.class));

        } else if (id == R.id.habito4) {
            startActivity(new Intent(MainActivityH7.this, MainActivityH4.class));

        } else if (id == R.id.habito5) {
            startActivity(new Intent(MainActivityH7.this, MainActivityH5.class));

        } else if (id == R.id.habito6) {
            startActivity(new Intent(MainActivityH7.this, MainActivityH6.class));

        } else if (id == R.id.habito7) {
            startActivity(new Intent(MainActivityH7.this, MainActivityH7.class));


        } else if (id == R.id.habito8) {
            startActivity(new Intent(MainActivityH7.this, MainActivityH8.class));
    ...
    public void logout() {
        ...
        editor.clear();
        editor.commit();
        startActivity(new Intent(MainActivityH7.this, MainActivity.class));
    }


    public void guardarh7() {
        ...
        requestParams.add("habito", String.valueOf(7));
