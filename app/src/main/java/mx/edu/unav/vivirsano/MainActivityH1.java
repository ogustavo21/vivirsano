...
public class MainActivityH1 extends AppCompatActivity implements IFragmentToActivity, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainhuno);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_viewh1);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            if (fragment != null) {
                switch (position) {
                    case 0:
                        ((TabFragmentH11) fragment).onRefresh();
                        break;
                    case 1:
                        ((TabFragmentH12) fragment).onRefresh();
                        break;
                    case 3:
                        ((TabFragmentH13) fragment).onRefresh();
                        break;
                }
            }
            startActivity(new Intent(MainActivityH1.this, datosSesion.class));
           //return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.habito1) {
            ...
            startActivity(new Intent(MainActivityH1.this, MainActivityH1.class));
        } else if (id == R.id.habito2) {
            startActivity(new Intent(MainActivityH1.this, MainActivityH2.class));

        } else if (id == R.id.habito3) {
            startActivity(new Intent(MainActivityH1.this, MainActivityH3.class));
        } else if (id == R.id.habito4) {
            startActivity(new Intent(MainActivityH1.this, MainActivityH4.class));

        } else if (id == R.id.habito5) {
            startActivity(new Intent(MainActivityH1.this, MainActivityH5.class));

        } else if (id == R.id.habito6) {
            startActivity(new Intent(MainActivityH1.this, MainActivityH6.class));

        } else if (id == R.id.habito7) {
            startActivity(new Intent(MainActivityH1.this, MainActivityH7.class));


        } else if (id == R.id.habito8) {
            startActivity(new Intent(MainActivityH1.this, MainActivityH8.class));
    ...
    public void logout(){
        ...
        editor.clear();
        editor.commit();
        startActivity(new Intent(MainActivityH1.this, MainActivity.class));
    }
    ...
    public void guardar(){
        ...
        requestParams.add("habito", String.valueOf(1));
